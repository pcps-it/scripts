...
# Variables
plistDomain="net.pcps"                     # Hard-coded domain name (i.e., "com.company")
...
<plist version=\"1.0\">
    <dict>
        ...
        <array>
            <string>sh</string>
            <string>/Library/PCPS/scripts/reconAtReboot.sh</string>
        </array>
        <key>RunAtLoad</key>
        <true/>
    </dict>
...
/bin/rm -fv /Library/PCPS/scripts/reconAtReboot.sh

exit 0" > /Library/PCPS/scripts/reconAtReboot.sh

# Set the permission on the file
ScriptLog "* Set script file permissions ..."
/usr/sbin/chown root:wheel /Library/PCPS/scripts/reconAtReboot.sh
/bin/chmod 644 /Library/PCPS/scripts/reconAtReboot.sh
/bin/chmod +x /Library/PCPS/scripts/reconAtReboot.sh
