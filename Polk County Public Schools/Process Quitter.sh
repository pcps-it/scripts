...
#	Version: 1.1
#
#	Created by John Kitzmiller on 6/14/14
#	Modified by Justin Phillips on 10/27/16
#
...
description1="needs to quit before ${applicationTitle} can be installed.
Click OK to quit."
...
# to provide more prompts for the user.
	...
	promptResult=`"${jamfHelper}" -lockHUD -windowType utility -icon "$dialogIcon" \
	-title "$title" \
	-heading "$1" \
	-alignHeading center \
	-description "$3 $2" \
